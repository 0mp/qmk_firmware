...
Install the official FreeBSD package for QMK CLI by running:

    pkg install -g "py*-qmk"
    
Remember to follow the instructions printed at the end of installation. Use `pkg info -Dg "py*-qmk"` to show it again.
